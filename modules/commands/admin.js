...
module.exports.languages = {
    "vi": {
        ...
        "notHavePermssion": 'Bạn không có quyền điều hành bot',
...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
        ...
        if (adminbox[threadID] == true) {
            ...
            api.sendMessage("❯ Tắt thành công chế độ admin và qtv「tất cả mọi người đều có thể sử dụng bot」", threadID, messageID);
        } else {
            adminbox[threadID] = true;
            api.sendMessage("❯ Bật thành công chế độ admin và qtv「chỉ admin và qtv box mới có thể sử dụng bot」", threadID, messageID);
        }
