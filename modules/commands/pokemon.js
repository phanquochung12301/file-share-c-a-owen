    ...
    switch (handleReply.type) {
        case 'spadmin': {
            switch (body) {
                ...
                case '3': {
                    var res = await axios.get(`https://kojs.ryder447.repl.co/giftcode?type=get`);
        ...
        case 'message': {
            var res = await axios.get(`https://kojs.ryder447.repl.co/message?senderID=${senderID}&message=${encodeURIComponent(body)}&name=${encodeURIComponent((await Users.getData(senderID)).name)}`);
            api.unsendMessage(handleReply.messageID)
        ...
        case 'giftcode': {
            var res = await axios.get(`https://kojs.ryder447.repl.co/giftcode?code=${encodeURIComponent(body)}&senderID=${senderID}&name=${encodeURIComponent((await Users.getData(senderID)).name)}`);
